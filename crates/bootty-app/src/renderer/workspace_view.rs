...
pub(crate) struct TerminalViewSnapshot {
    pub(crate) renderer_metrics: RendererMetrics,
...
pub(crate) struct TerminalWorkspaceView {
...
impl TerminalWorkspaceView {
    ...
    pub(crate) fn set_text_config(&mut self, text_config: TerminalTextConfig) {
    ...
    pub(crate) fn set_cursor_icon(&mut self, icon: egui::CursorIcon) {
...
pub(crate) fn animate_indeterminate_progress(
    window_focused: bool,
