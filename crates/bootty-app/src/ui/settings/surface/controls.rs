...
impl DragHandle {
    ...
    pub(super) fn paint_in(&self, ui: &mut egui::Ui, palette: ThemePalette, rect: Rect) {
...
pub(super) fn apply_reorder<T>(items: &mut Vec<T>, from: usize, slot: usize) {
    if from >= items.len() {
        return;
    }
...
pub(super) fn settings_page_header(ui: &mut egui::Ui, palette: ThemePalette, title: &str) {
    ui.label(
...
pub(super) fn section(ui: &mut egui::Ui, palette: ThemePalette, title: &str) {
    ui.add_space(12.0);
    ui.label(
        RichText::new(title)
...
pub(super) fn settings_toggle(ui: &mut egui::Ui, palette: ThemePalette, value: &mut bool) -> bool {
...
pub(super) fn settings_notice(ui: &mut egui::Ui, color: Color32, text: &str) {
    ui.label(
        RichText::new(text)
...
pub(super) fn settings_text_edit(
    ui: &mut egui::Ui,
    palette: ThemePalette,
    value: &mut String,
    hint: &str,
...
pub(super) fn settings_text_edit_width(
    ui: &mut egui::Ui,
    palette: ThemePalette,
    value: &mut String,
    hint: &str,
...
pub(super) fn settings_segmented(
    ui: &mut egui::Ui,
    palette: ThemePalette,
    labels: &[&str],
    selected: usize,
...
pub(super) fn settings_segmented_ltr(
    ui: &mut egui::Ui,
    palette: ThemePalette,
    labels: &[&str],
    selected: usize,
...
pub(super) fn settings_color_picker(
    ui: &mut egui::Ui,
    palette: ThemePalette,
    rgb: &mut [u8; 3],
) -> egui::Response {
...
pub(super) fn settings_value_chip(ui: &mut egui::Ui, palette: ThemePalette, text: &str) {
    egui::Frame::NONE
